...
export declare class NglCheckboxGroup implements OnChanges, AfterContentInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NglCheckboxGroup, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NglCheckboxGroup, "ngl-checkbox-group,[ngl-checkbox-group]", never, { "type": "type"; "label": "label"; "error": "error"; "required": "required"; }, {}, ["options"], ["*"], false>;
}
