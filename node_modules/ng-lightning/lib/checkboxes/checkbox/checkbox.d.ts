...
export declare class NglCheckbox implements OnChanges, AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NglCheckbox, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NglCheckbox, "ngl-checkbox,[ngl-checkbox]", never, { "label": "label"; "error": "error"; "stacked": "stacked"; }, {}, ["input"], ["*"], false>;
}
