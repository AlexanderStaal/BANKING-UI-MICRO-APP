...
export declare class NglOverlaynglOverlayScrolledOutsideViewDirective implements OnInit, OnDestroy {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NglOverlaynglOverlayScrolledOutsideViewDirective, [{ self: true; }, null, null]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<NglOverlaynglOverlayScrolledOutsideViewDirective, "[nglOverlayScrolledOutsideView]", never, {}, { "overlayOutside": "nglOverlayScrolledOutsideView"; }, never, never, false>;
}
/**
...
//# sourceMappingURL=overlay-outside.d.ts.map