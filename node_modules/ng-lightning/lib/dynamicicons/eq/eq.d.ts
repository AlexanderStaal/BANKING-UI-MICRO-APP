...
export declare class NglDynamicIconEq extends BaseDynamicIconComponent {
    ...
    private _option;
    isAnimated(): boolean;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NglDynamicIconEq, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NglDynamicIconEq, "ngl-dynamic-icon-eq", never, { "option": "option"; }, {}, never, never, false>;
}
