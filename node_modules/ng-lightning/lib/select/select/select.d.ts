...
export declare class NglSelect implements OnChanges, AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NglSelect, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NglSelect, "ngl-select,[ngl-select]", never, { "label": "label"; "fieldLevelHelpTooltip": "fieldLevelHelpTooltip"; "error": "error"; }, {}, ["input"], ["*"], false>;
}
