...
export declare class NglTextarea implements OnChanges, AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NglTextarea, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NglTextarea, "ngl-textarea,[ngl-textarea]", never, { "label": "label"; "fieldLevelHelpTooltip": "fieldLevelHelpTooltip"; "error": "error"; }, {}, ["input"], ["*"], false>;
}
