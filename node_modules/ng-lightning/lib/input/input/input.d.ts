...
export declare class NglInput implements OnChanges, AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NglInput, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NglInput, "ngl-input,[ngl-input]", never, { "label": "label"; "error": "error"; "stacked": "stacked"; "fieldLevelHelpTooltip": "fieldLevelHelpTooltip"; }, {}, ["input"], ["*"], false>;
}
