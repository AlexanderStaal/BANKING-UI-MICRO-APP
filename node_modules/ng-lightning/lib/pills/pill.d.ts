...
export declare class NglPill implements OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NglPill, "ngl-pill", never, { "hasError": "hasError"; "removable": "removable"; "removeTitle": "removeTitle"; "icon": "icon"; "avatar": "avatar"; }, { "remove": "remove"; }, never, ["a", "*"], false>;
}
