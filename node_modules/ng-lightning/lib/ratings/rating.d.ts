...
export declare class NglRating implements OnInit, AfterContentInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NglRating, "ngl-rating", never, { "icon": "icon"; "readonly": "isReadonly"; "colorOn": "colorOn"; "colorOff": "colorOff"; "rate": "rate"; "max": "max"; "size": "size"; }, { "rateChange": "rateChange"; "hover": "hover"; }, ["iconTemplate"], never, false>;
}
